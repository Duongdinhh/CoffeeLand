...
namespace CoffeeLand
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CoffeeLandDbContext>(opts => {
                opts.UseSqlServer(
                Configuration["ConnectionStrings:CoffeeLandConnection"]);
            });
            services.AddScoped<ICoffeeLandRepository, EFCoffeeLandRepository>();
